	...
	//Fallthrough
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Clwn_2, "    OG RAYMAN MOD", false},
                {StageId_Clwn_2, "NLEEBOY", false},
				{StageId_Clwn_2, "BENZ15471", false},
				{StageId_Clwn_2, "SMASHINGBAG", false},
				{StageId_Clwn_2, "WEEDEET", false},
				{StageId_Clwn_2, "HAEMD", false},

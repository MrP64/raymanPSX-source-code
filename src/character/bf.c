...
void Char_BF_Tick(Character *character)
{
	...
	if (stage.flag & STAGE_FLAG_JUST_STEP)
	{
		...
		if (stage.stage_id == StageId_1_1 && stage.song_step == 1208)	{			
			character->set_anim(character, PlayerAnim_Peace);
		}

		if (stage.stage_id == StageId_1_1 && stage.song_step == 1532)	{			
			character->set_anim(character, PlayerAnim_Peace);
		}

		if (stage.stage_id == StageId_1_1 && stage.song_step == 1904)	{			
			character->set_anim(character, PlayerAnim_Peace);
		}
	}

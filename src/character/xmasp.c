...
static const CharFrame char_xmasp_frame[] = {
	...
	{XmasP_ArcMain_LeftA0, {0,   0, 214, 190}, {130, 182}}, //4 left a 1
	{XmasP_ArcMain_LeftA1, {0,   0, 214, 190}, {130, 182}}, //5 left a 2
	{XmasP_ArcMain_LeftB0, {0,   0, 110, 142}, {130, 182}}, //6 left b 1
	{XmasP_ArcMain_LeftB1, {0,   0, 110, 142}, {130, 182}}, //7 left b 2

	{XmasP_ArcMain_DownA0, {0,   0, 214, 190}, {130, 180}},  //8 down a 1
	{XmasP_ArcMain_DownA1, {0,   0, 214, 190}, {130, 180}}, //9 down a 2
	...
	{XmasP_ArcMain_UpB0, {0,   0, 214, 190}, {130, 182}}, //14 up b 1
	{XmasP_ArcMain_UpB1, {0,   0, 214, 190}, {130, 182}}, //15 up b 2
	{XmasP_ArcMain_UpB2, {0,   0, 214, 190}, {130, 182}}, //15 up b 2
...
static const Animation char_xmasp_anim[CharAnim_Max] = {
	...
	{2, (const u8[]){14, 15, 16, 16, ASCR_BACK, 1}},         //CharAnim_UpAlt
	{2, (const u8[]){17, 18, ASCR_BACK, 1}},         //CharAnim_Right
	{2, (const u8[]){19, 20, ASCR_BACK, 1}},         //CharAnim_RightAlt
};
...
void Char_XmasP_Tick(Character *character)
{
	...
	//legends peace code
	if (stage.stage_id == StageId_1_1 && stage.song_step == 700)	{			
		character->set_anim(character, CharAnim_UpAlt);
	}

	if (stage.stage_id == StageId_1_1 && stage.song_step == 1272)	{			
		character->set_anim(character, CharAnim_UpAlt);
	}

	if (stage.stage_id == StageId_1_1 && stage.song_step == 1468)	{			
		character->set_anim(character, CharAnim_UpAlt);
	}

	if (stage.stage_id == StageId_1_1 && stage.song_step == 1840)	{			
		character->set_anim(character, CharAnim_UpAlt);
	}
}
